          ...
          <div class="card-body">
              <form id="frm-addstore">
                  ...
                  <div class="row">
                    	...
                    	<div class="form-group">
											  <label for="ddl-asl-markers"><?php echo __('Marker','asl_admin') ?></label>
											    ...
											    <select id="ddl-asl-markers">
											      ...
											      <option value="<?php echo $m->id?>" data-imagesrc="<?php echo ASL_UPLOAD_URL.'icon/'.$m->icon;?>" data-description="&nbsp;"><?php echo $m->marker_name;?></option>
											      <?php endforeach; ?>
											    </select>
                    ...
                    <div class="col-md-6 form-group mb-3">
                      <label for="txt_product"><?php echo __('Product','asl_admin') ?></label>
                      <select name="ddl_product"  id="ddl_product" multiple class="asl-chosen chosen-select-width form-control">                      
                        <?php foreach($products as $product): ?>
                          <option  <?php foreach($store_product as $s_product ) if($s_product == $product->id) echo 'selected="selected" '; ?> value="<?php echo $product->id ?>"><?php echo $product->name ?></option>
                        <?php endforeach ?>
                      </select>
                    </div>
                    <div class="col-md-6 form-group mb-3">
