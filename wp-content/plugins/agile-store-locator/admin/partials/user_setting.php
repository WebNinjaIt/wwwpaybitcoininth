          	...
          	<form id="frm-usersetting">
          		<div class="row mt-2">
          			<div class="col-md-4 form-group mb-4">
							  ...
							  <div class="col-md-4 form-group mb-4">
							    <label><?php echo __('Google Server API Key','asl_admin') ?></label>
							    ...
							    <p class="help-p text-muted"><a target="_blank" class="text-muted" href="https://agilestorelocator.com/wiki/what-is-google-server-key/"><?php echo __('What is Google Server Key?','asl_admin') ?></a></p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							    <label><?php echo __('Notification Email','asl_admin') ?></label>
							    <input  type="text" class="form-control" name="data[notify_email]" id="asl-notify_email" placeholder="<?php echo __('Notification Email for [ASL_FORM]','asl_admin') ?>">
							  </div>
							  <div class="col-md-4 form-group mb-4">
          			...
          			<div class="col-md-4 form-group mb-4">
							  ...
							  <div class="col-md-4 form-group mb-4 full">
							    ...
							    <a target="_blank" class="text-muted" href="https://agilestorelocator.com/wiki/what-is-google-server-key/"><?php echo __('What is Google Server','asl_admin') ?></a></p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							...
							<div class="row">
							  ...
							  <div class="col-md-4 form-group mb-4">
							    <div class="custom-control custom-checkbox">
									...
									<p class="help-p text-muted">(<?php echo __('Store Locator will consider Default Lat & Lng as the center point','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" value="1" class="custom-control-input" name="data[geo_marker]" id="asl-geo_marker">
                    <label class="custom-control-label" for="asl-geo_marker"><?php echo __('Location Marker','asl_admin') ?></label>
                  </div>
                  <p class="help-p text-muted">(<?php echo __('To remove the pin location marker','asl_admin') ?>)</p>
                </div>
							  ...
							  <div class="col-md-4 form-group mb-4">
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" value="1" class="custom-control-input" name="data[and_filter]" id="asl-and_filter">
                    <label class="custom-control-label" for="asl-and_filter"><?php echo __('AND Filter','asl_admin') ?></label>
                  </div>
                  <p class="help-p text-muted">(<?php echo __('To change the Category filter logic from OR to AND','asl_admin') ?>)</p>
                </div>
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
									...
									<p class="help-p text-muted">(<?php echo __('Works when parent container doesn\'t have limited width applied','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
									...
									<p class="help-p red">(<?php echo __('Warning! Category icons will be used if exist, Manage Markers will not be used','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
							    ...
							    <p class="help-p text-muted">(<?php echo __('Radius Circle will only appear with Dropdown Control, it overrides the search zoom value, as it fit bound to the radius circle','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
							    ...
							    <p class="help-p text-muted">(<?php echo __('Sort list random on the load of the Store Locator','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" value="1" class="custom-control-input" name="data[category_bound]" id="asl-category_bound">
                    <label class="custom-control-label" for="asl-category_bound"><?php echo __('Category Bound','asl_admin') ?></label>
                  </div>
                  <p class="help-p text-muted">(<?php echo __('Fit bound to markers when a category is selected','asl_admin') ?>)</p>
                </div>
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
									  <input type="checkbox" value="1" class="custom-control-input" name="data[sort_random]" id="asl-sort_random">
							  ...
							  <div class="col-md-4 form-group mb-4">
							  	<div class="custom-control custom-checkbox">
									  <input type="checkbox" value="1" class="custom-control-input" name="data[admin_notify]" id="asl-admin_notify">
									  <label class="custom-control-label" for="asl-admin_notify"><?php echo __('Notification','asl_admin') ?></label>
									</div>
							    <p class="help-p text-muted">(<?php echo __('Send email notification for the newly registered Store through frontend form','asl_admin') ?>)</p>
							  </div>
							  <div class="col-md-4 form-group mb-4">
                  <div class="custom-control custom-checkbox">
                  ...
                  <p class="help-p text-muted">(<?php echo __('Display a GDPR consent message to accept the law','asl_admin') ?>)</p>
                </div>
          		</div>
          		<div class="row mb-4">
          			<div class="col-md-4">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <select id="asl-template" class="custom-select col-md-12" name="data[template]">
                                ...
                                <option value="list"><?php echo __('Template','asl_admin') ?> List (BETA version)</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                    	<div class="template-box box_layout_list box_layout_3 box_layout_0 hide">
										  ...
										  <div class="template-box box_layout_0 box_layout_3 box_layout_list hide">
