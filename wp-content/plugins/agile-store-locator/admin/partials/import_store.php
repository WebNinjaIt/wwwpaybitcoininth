          ...
          <div class="card-body">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <div class="form-group">
                  <div class="custom-control custom-checkbox">
                    <input type="checkbox" class="custom-control-input" id="asl-logo-images">
                    <label class="custom-control-label" for="asl-logo-images"><?php echo __('Export with Logo Images Path','asl_admin') ?></label>
                  </div>
                </div>
              </div>
              <div class="col-md-8">
                <div class="float-md-right">
                  ...
                  <button type="button" class="btn btn-danger mr-2" data-loading-text="<?php echo __('Deleting...','asl_admin') ?>" id="asl-delete-stores"><i><svg width="13" height="13"><use xlink:href="#i-trash"></use></svg></i><?php echo __('Delete All Stores','asl_admin') ?></button>
