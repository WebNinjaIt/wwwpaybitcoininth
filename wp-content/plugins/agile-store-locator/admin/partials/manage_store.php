        ...
        <div class="card p-0 mb-4">
          ...
          <div class="card-body">
            ...
            <?php if($pending_stores > 0): ?>
              <div id="alert-pending-stores" class="alert alert-warning mt-3 mb-3" role="alert"><?php echo __('You have pending stores to approve them.','asl_admin') ?> <a id="btn-pending-stores" class="btn ml-md-2 btn-warning btn-sm" data-pending="<?php echo __('Hide Pending Stores','asl_admin') ?>" data-all="<?php echo __('Show Pending Stores','asl_admin') ?>" data-loading-text="<?php echo __('Loading Stores','asl_admin') ?>"><span><?php echo __('Show Pending Stores','asl_admin') ?></span> <i class="badge badge-light"><?php echo $pending_stores ?></i></a></div>
            <?php endif; ?>  
