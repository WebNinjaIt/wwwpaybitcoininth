...
(function($, app_engine) {
  ...
  var map,
    map_object = {
      ...
      add_marker: function(_loc) {
        ...
        var marker_icon = new google.maps.MarkerImage(ASL_Instance.plugin_url + 'admin/images/pin1.png');
  ...
  app_engine['pages'] = {
        ...
        aswal({
          ...
          .then(function(result) {
            ...
            if (result) {
              ...
              ServerCall(ASL_REMOTE.URL + "?action=asl_add_attribute", { title: _params.title, name: _params.name, value: result, ordr: $attr_ordr_input.val() }, function(_response) {
      ...
      $('#tbl_attribute tbody').on('click', '.edit_attr', function(e) {
        ...
        .then(function(result) {
          ...
          if (result) {
            ...
            ServerCall(ASL_REMOTE.URL + "?action=asl_update_attribute", { id: _id, title: _params.title, name: _params.name, value: result, ordr: $attr_ordr_input.val() }, function(_response) {
    ...
    dashboard: function() {
      ...
      ///Button to Migrate Assets
      $('#btn-migrate-assets').bind('click', function(e) {

        var $this = $(this);

        $this.bootButton('loading');

        ServerCall(ASL_REMOTE.URL + '?action=asl_migrate_assets', {}, function(_response) {
      ...
      $('#sl-btn-tmpl-backup').bind('click', function(e) {
        ...
        aswal({
          ...
          text: ASL_REMOTE.LANG.backup_tmpl_msg,
          type: 'question',
          html: '<select class="custom-select" id="sl-tmpl-section-1"><option value="0">Template 0</option><option value="1">Template 1</option><option value="2">Template 2</option><option value="3">Template 3</option><option value="list">Template List</option><option value="form">Store Form</option><option value="store">Store Detail</option></select>',
          showCancelButton: true,
          confirmButtonColor: "#DD6B55",
          ...
          preConfirm: function(_value) {
            ...
            return new Promise(function(resolve, reject) {
              ...
              ServerCall(ASL_REMOTE.URL + "?action=asl_backup_tmpl", { template: _value }, function(_response) {
                ...
                if (_response.success) {
                  ...
                  atoastr.error((_response.msg || 'Error! Request fails, check permissions.'));
                  return;
                }
      ...
      $('#sl-btn-tmpl-remove').bind('click', function(e) {
        ...
        aswal({
          ...
          type: 'question',
          html: '<select class="custom-select" id="sl-tmpl-section-2"><option value="0">Template 0</option><option value="1">Template 1</option><option value="2">Template 2</option><option value="3">Template 3</option><option value="list">Template List</option><option value="form">Store Form</option><option value="store">Store Detail</option></select>',
          showCancelButton: true,
          confirmButtonColor: "#DD6B55",
          ...
          preConfirm: function(_value) {
            ...
            return new Promise(function(resolve, reject) {
              ...
              ServerCall(ASL_REMOTE.URL + "?action=asl_remove_tmpl", { template: _value }, function(_response) {
    ...
    add_store: function(_is_edit, _store) {
      ...
      */
      ...
      $('#ddl_product').chosen({
        width: "100%",
        placeholder_text_multiple: ASL_REMOTE.LANG.select_product || 'Select',
        no_results_text: ASL_REMOTE.LANG.no_product || 'None'
      });
      ...
      $('#btn-asl-add').bind('click', function(e) {
        ...
        formData['data[product]']  = $('#ddl_product').val();
    ...
    import_store: function() {
      ...
      $('#export_store_file_').bind('click', function(e) {
        ...
        ServerCall(ASL_REMOTE.URL + '?action=asl_export_file', { data_: "", logo_image: (document.getElementById('asl-logo-images').checked) ? 1 : 0, with_id: (document.getElementById('asl-export-ids').checked) ? 1 : 0 }, function(_response) {
