...
<div id="asl-search" class="asl-cont asl-search">
    <div class="container">
      <section class="asl-search-cont" <?php echo $bg_color ?>>
        <h3><?php echo __('Search your Location', 'asl_locator') ?></h3>
        <div class="row">
            <div class="col-lg-12">
                <div class="row asl-search-widget text-center center-block">
                    <div class="col-md-<?php echo $search_columns ?> p-0">
                        ...
                        <input data-submit="disable"  id="auto-complete-search" class="form-control asl-search-cntrl isp_ignore border-r-0" placeholder="<?php echo __( 'Enter a Location', 'asl_locator') ?>">
                        <span class="err-spn"><?php echo __( 'Destination missing or invalid', 'asl_locator') ?></span>
                        <a title="<?php echo __( 'Current Location', 'asl_locator') ?>" class="sl-geo-btn asl-geo">
