...
<section id="asl-storelocator" class="asl-cont asl-template-3 asl-layout-<?php echo $all_configs['layout']; ?> asl-bg-<?php echo $all_configs['color_scheme'].$class; ?> asl-text-<?php echo $all_configs['font_color_scheme'] ?>">
...
<script id="tmpl_list_item" type="text/x-jsrender">
    ...
    {{if path}}
    <div class="sl-img-cont"><img src="<?php echo ASL_UPLOAD_URL ?>Logo/{{:path}}" alt="" class="img-fluid" /></div>
    {{/if}}
