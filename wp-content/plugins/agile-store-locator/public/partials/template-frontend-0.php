        ...
        <div class="<?php if($all_configs['search_2']) echo 'no-pad'; ?>">
          <div class="row">
            ...
            <div class="col-xs-12 col-sm-4 col-md-4 search_filter asl-name-search">
              ...
              <div class="sl-search-group"><input type="text" tabindex="2"  placeholder="<?php echo __( 'Search Name', 'asl_locator') ?>"  class="asl-search-name form-control isp_ignore"></div>
            </div>
            <?php endif ?>
